      ...
      <div className="container mx-auto flex items-center justify-between px-4 sm:px-6 lg:px-12">
        ...
        <div className="flex items-center justify-between space-x-4">
          ...
          <div className="hidden md:block">
            <SearchTask handleSearch={handleSearch} seachTrum={seachTrum} />
          </div>
          ...
          >
            <div className="relative w-8 h-8 sm:w-9 sm:h-9">
              ...
              {/* Moon Icon (Dark Mode) */}
              <svg
                className={`absolute transition-all duration-500 ease-in-out fill-current text-green-700 transform ${
                  theme === "light"
                    ? "opacity-100 rotate-0 scale-100"
                    : "opacity-0 rotate-180 scale-0"
                }`}
